...
GameplayOptions::GameplayOptions()
    ...
    , numAutoPickupRadius("Auto Pickup Radius", OptionEntryFlags::None, N_("Auto Pickup Radius"), N_("Increases the range at which items are automatically picked up."), 1, {0, 1, 2, 3})
